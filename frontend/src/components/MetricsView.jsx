...
export default function MetricsView() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-6 space-y-8">
      ...
      {/* Results Table */}
      <div className="bg-slate-900 border border-slate-800 rounded-xl p-5 shadow overflow-x-auto">
        ...
        <table className="w-full text-left text-sm text-slate-300">
          ...
          <tbody className="divide-y divide-slate-800/60 font-mono text-xs">
            <tr className="bg-slate-950/40 text-slate-400">
              <td className="py-3 px-4 font-bold text-slate-300">Baseline</td>
              <td className="py-3 px-4">—</td>
              <td className="py-3 px-4">—</td>
              <td className="py-3 px-4">—</td>
              <td className="py-3 px-4">2.7832</td>
              <td className="py-3 px-4">16.17</td>
              <td className="py-3 px-4 font-sans text-slate-500">Untuned Qwen2.5-1.5B Base</td>
            </tr>
            ...
            <tr className="hover:bg-slate-800/40">
              ...
              <td className="py-3 px-4 font-sans text-slate-400">Stable, undertrained</td>
            </tr>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-slate-900 border border-slate-800 rounded-xl p-4 shadow flex flex-col">
          <h4 className="text-sm font-semibold text-slate-200 mb-3 flex items-center justify-between">
            <span>Run A2 Loss Curve</span>
            <span className="text-xs text-slate-500 font-mono">r=8, lr=5e-5 (257 rows)</span>
          </h4>
          <div className="flex-1 bg-slate-950 rounded-lg overflow-hidden border border-slate-800 flex items-center justify-center p-2">
            <img
